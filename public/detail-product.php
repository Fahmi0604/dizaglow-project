    ...
    <div class="mt-[70px] pb-[44px] lg:pb-[88px] bg-custom-black py-[7.5%] px-[24px] md:px-[10%] lg:py-[10%] lg:px-[7.5%] font-Proxima">
        ...
        <section class="flex mb-12">
                ...
                <div class="swiper mySwiper2">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="assets/produk1.png" alt="Img Product" />
                        </div>
                        <div class="swiper-slide">
                            <img src="assets/produk1.png" alt="Img Product" />
                        </div>
            ...
            <div class="w-[60%] ml-[10%]">
                <h1 class="text-white font-bold text-[20px] lg:text-[32px]">Acne Cream Night</h1>
                <div class="flex mt-2 mb-4 lg:mt-4 lg:mb-6">
                    <span class="text-custom-muted text-[16px] lg:text-2xl mr-4"><s>Rp 50,000</s></span>
                    <span class="text-secondary text-[16px] lg:text-2xl font-bold">Rp 25,000</span>
                </div>
                <div class="flex items-center mb-4 lg:mb-6">
                    <button class="inline-block text-white p-0 mr-4">
                        <svg class="w-[17px] lg:w-[24px]" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="inline-block text-white p-0">
                        <svg class="w-[17px] lg:w-[24px]" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="lg:flex w-full lg:w-1/2">
                    <!-- Qty Product -->
                    <div class="w-[50%] md:w-[120px] lg:w-[40%] border border-white rounded mr-4">
                        <div class="flex flex-row lg:h-10 w-full rounded relative bg-transparent text-base py-[2px] md:py-1">
                            ...
                            <input type="number" class="outline-none focus:outline-none text-center w-full bg-custom-black font-semibold text-xs md:text-md focus:text-black md:text-basecursor-default flex items-center focus:text-white text-white" id="counter-product" value="0"></input>
                    ...
                    <button class="bg-secondary text-white w-full py-3 text-xs font-bold border border-secondary rounded-md mt-5 lg:mt-0">
        ...
        <section>
            <h2 class="text-white text-md md:text-xl lg:text-2xl font-bold mb-3 lg:mb-4">Deskripsi</h2>
